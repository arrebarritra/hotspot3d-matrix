__global__ void hotspotOpt1_original(float *p, float* tIn, float *tOut, float sdc,
...
void hotspot_opt1_original(float *p, float *tIn, float *tOut,
        int nx, int ny, int nz,
        float Cap,
        ...
        float dt, int numiter)
{
    ...
    cudaFuncSetCacheConfig(hotspotOpt1_original, cudaFuncCachePreferL1);
    ...
    for (int i = 0; i < numiter; ++i) {
        hotspotOpt1_original<<<grid_dim, block_dim>>>
